    ...
    <section className="space-y-4">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
        {promotions.map((promo) => (
          <Link key={promo.id} href={promo.link} className="group relative aspect-[4/3] rounded-xl overflow-hidden">
            <Image
            ...
            />
            <div className={`absolute inset-0 ${promo.bgColor} opacity-80`} />
